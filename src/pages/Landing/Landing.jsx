...
const Landing = ({handleLandingHover}) => {
    ...
    <main class="landing" >
        <div className="landing__artwork">
            <img className = "landing__art landing__flower-1"src={pinkFlower} alt=""/>
            <img className = "landing__art landing__flower-2"src={orangeFlower} alt=""/>
            <img className = "landing__art landing__flower-3"src={greenLeaf} alt=""/>
            <img className = "landing__art landing__flower-4"src={pinkFlower} alt=""/>
            <img className = "landing__art landing__flower-5"src={whiteFlower} alt=""/>
            <img className = "landing__art landing__flower-6"src={orangePetals} alt=""/>
            <img className = "landing__art landing__flower-7"src={whitePetals} alt=""/>
        </div>
